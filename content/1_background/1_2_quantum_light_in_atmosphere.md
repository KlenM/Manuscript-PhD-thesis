...
The theory of quantum light propagation in the atmosphere is based on classical studies of light propagation through turbulent media.
...
Later, Tatarskii, building on the Rytov approximation, introduced the second-order perturbation term^[@tatarski1961], and presented a comprehensive theory of wave propagation in a turbulent atmosphere, rigorously connecting the statistical properties of refractive-index fluctuations with the resulting effects on optical waves^[@tatarskii1971].
This method is widely used for analyzing the statistical properties of optical fields propagating through a turbulent atmosphere, allowing one to compute quantities such as log-amplitude and phase variance functions, intensity and phase correlations, and structure functions.
...
Within the first-order Rytov approximation, the irradiance fluctuations are well described by the lognormal distribution^[@tatarskii1971,strohbehn1975].
...
The K-distribution^[@jakeman1978] is based on a modulation process in which the irradiance follows a conditional negative exponential modulated by a gamma-distributed process, providing good agreement with experimental data.
...
The quantity of interest in this regime is the probability density function of photocounts^[@mandel1995].
