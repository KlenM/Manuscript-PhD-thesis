...
Для вирішення цих проблем однією з основних цілей цього дослідження є встановлення меж застосовності наявних аналітичних моделей шляхом їх порівняння з результатами чисельного моделювання.
...
Ми оцінюємо точність прогнозів наявних аналітичних моделей за допомогою статистики Колмогорова-Смирнова, щоб виміряти, наскільки точно передбачення аналітичних моделей узгоджуються з чисельно змодельованими даними.
...
Ми провели систематичний аналіз властивостей та обмежень наявних аналітичних моделей.
...
У підсумку зазначимо, що у цій дисертації усунуто неоднозначності щодо розуміння та опису атмосферних квантових каналів.
Зокрема, встановлено, що наявні аналітичні моделі часто не здатні коректно врахувати асиметрію розподілу, залежну від розміру апертури.
